...
export default function Yearly3(){

return(
<Cards title="Yearly Targets " text="Targets Of The Year" >
...
<div className='flex ' > 
<div className="bg-[#cce3ff]  w-16 h-16 relative ml-4">
...
<div className="relative h-1 bg-blue-100 w-30 md:w-40 lg:w-72 mt-1 ">
...
<div className="bg-[#fdecce]  w-16 h-16 relative  ml-4">
...
<div className='flex mt-4'  > 
<div className="bg-[#d3f3df]  w-16 h-16 relative  ml-4">
